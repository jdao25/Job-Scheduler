/*
    Round-Robin (with a time slice of 2) functions
*/
...
// Calculate the Average Turnaround Time of Round-Robin 2
...
{
    /*
        Calcuate the Average Turnaround Time of Round-Robin 2
